...
Biblioteka ARY to zbiór funkcji służących do dostępu do struktur
danych Starlink ARRAY (tablic) przy użyciu hierarchicznego systemu
danych HDS.
...
Pliki nagłówkowe bibliotek ARY.
